...
class _ProductDetailPageState
  ...
  void initState() {
    super.initState();
    context.read<ProductDetailController>().initial(widget.order != null, widget.order?.amount ?? 1);
  }
                ...
                builder: (context, amount) {
                  return Container(
                      ...
                      child: DeliveryIncrementDecrementButton(
                        amount: amount,
                        decrementTap: () => context.read<ProductDetailController>().decrement(),
                        incrementTap: () => context.read<ProductDetailController>().increment(),
                      ));
                },
              ),
              Container(
                        ...
                        child: Visibility(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: AutoSizeText(
                                  'R\$ ${(widget.product.price * amount).currencyPTBR}',
                                  maxFontSize: 13,
                                  minFontSize: 5,
